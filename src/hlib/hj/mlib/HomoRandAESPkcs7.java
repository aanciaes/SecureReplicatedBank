...
public class HomoRandAESPkcs7 {
	...
	public static SecretKey keyFromString(String str){
		return (SecretKey) hlib.hj.mlib.HelpSerial.fromString(str);
	}
	
	public static String stringFromKey(SecretKey secretKey){
		return hlib.hj.mlib.HelpSerial.toString(secretKey);
	}
	...
	public static hlib.hj.mlib.RandomKeyIv keyIvFromString(String str){
		return (hlib.hj.mlib.RandomKeyIv) hlib.hj.mlib.HelpSerial.fromString(str);
	}
	
	public static String stringFromKeyIv(hlib.hj.mlib.RandomKeyIv secretKey){
		return HelpSerial.toString(secretKey);
	}
	
	public static hlib.hj.mlib.RandomKeyIv generateKeyIv(){
    ...
    public static String encrypt(String keyIv, String valor){
    	...
    	return encrypt(hlib.hj.mlib.HomoRand.keyIvFromString(keyIv).getKey(), hlib.hj.mlib.HomoRand.keyIvFromString(keyIv).getiV(), valor);
    }
    
    public static String decrypt(String keyIv, String valor){
    	
    	return decrypt(hlib.hj.mlib.HomoRand.keyIvFromString(keyIv).getKey(), HomoRand.keyIvFromString(keyIv).getiV(), valor);
    }
